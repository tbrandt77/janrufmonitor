...
public class FritzOSFirmware extends AbstractFritzBoxFirmware {
	...
	private final static String PATTERN_DETECT_FIRMWARE_05_50 = "\\&version=(\\d\\d\\d*).(\\d\\d).(\\d\\d\\d*)\\&"; 
	private final static String PATTERN_DETECT_LANGUAGE_DE = "\\[\"language\"\\] = \"de\"";
	
	private String m_sid;
	private String m_response;
	
	public FritzOSFirmware(String box_address, String box_port,
			String box_password, String box_user) {
	...
	FirmwareData detectFritzBoxFirmware() throws FritzBoxDetectFirmwareException {
		StringBuffer data = new StringBuffer();
		String urlstr = "http://" + this.m_address +":" + this.m_port + "/login.lua";
		...
		this.m_logger.info("Using firmware detection pattern: "+PATTERN_DETECT_FIRMWARE_05_50);
		Pattern p = Pattern.compile(PATTERN_DETECT_FIRMWARE_05_50);
		Matcher m = p.matcher(data);
		if (m.find()) {
