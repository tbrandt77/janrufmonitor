...
public class VcfParser30 {
	...
	protected IPhonenumber parsePhonenumber(String n) {
		...
		pn = PhonenumberAnalyzer.getInstance(PIMRuntime.getInstance()).toIdentifiedPhonenumber("0"+PhonenumberAnalyzer.getInstance(PIMRuntime.getInstance()).normalize(n.trim()));
		if (pn != null) return pn;
